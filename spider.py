...
#print(comments.text)
re_sub = re.sub('jQuery(.*?)\(',' ',comments)
re_sub2 = re.sub('\)\;',' ',re_sub)
#data = re.compile(pat).findall(comments)
#datas = data[0].split(',')
#data = re.search(data,url)
json_sub = json.loads(re_sub2)
print(json_sub['data']['diff'][1]['f1'])
